...
<body>
	...
	<!-- ***CENTER IMAGE*** -->
	<!-- <img id="image1" onclick="changeImage()" src="view/images/test3.jpg"> -->
...
<div class="footer">
	<div class="footer_contents">
		...
		<center>
			...
			- 
			<a href= "http://localhost:8080/offTheGridSol/home"> Trade Mark of O.G.S.June 2014</a> - 
			<a href= "http://localhost:8080/offTheGridSol/termsOfUse"> Terms Of Use</a> - 
			<a href= "http://localhost:8080/offTheGridSol/designerDevelopment"> Web Development & Design </a>
			</center>
		</div>
	</div>
</div>
...
<!-- ***END OF BODY*** -->
<!-- TODO:Encapsulate in a single global function call for all pages in this format -->
</html>
